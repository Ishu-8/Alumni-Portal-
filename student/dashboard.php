...
<body>
    ...
    <div class="container">
        <h1><i class="fas fa-user"></i> Student Dashboard</h1>

        <div class="card">
            <h2><i class="fas fa-graduation-cap"></i> Student Features</h2>
            <ul>
                <li><i class="fas fa-briefcase"></i> Browse job and internship opportunities</li>
                <li><i class="fas fa-calendar-alt"></i> Explore events and workshops shared by alumni</li>
                <li><i class="fas fa-file-download"></i> Download shared documents, PPTs, and videos</li>
                <li><i class="fas fa-comments"></i> Interact with alumni for career guidance</li>
            </ul>
            <div>
                <a class="btn" href="../posts/list_posts.php"><i class="fas fa-search"></i> View Opportunities</a>
                <a class="btn" href="../events/list_events.php"><i class="fas fa-calendar-check"></i> View Events</a>
            </div>
        </div>
