...
<div class="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="<?php echo $dashboard_url; ?>"> Admin Dashboard</a>
...
<div class="container">
    ...
    <table>
        ...
        <tr>
            ...
            <?php if($role == 'admin'){ ?>
            <td><a class="delete" href="?delete=<?php echo $row['id']; ?>" onclick="return confirm('Delete this message?')">Delete</a></td>
            <?php } ?>
        </tr>
        <?php } ?>
    </table>
